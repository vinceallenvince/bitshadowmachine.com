var palette = new BitShadowMachine.ColorPalette();
      ...
      Box.prototype.init = function(options) {
        ...
        this.color = options.color || [255, 155, 255];
      ...
      Box.prototype.step = function () {
        ...
        var ampY = this.amplitude.y * SimplexNoise.noise(BitShadowMachine.System.clock * 0.01, 0);
        ...
        this.opacity = BitShadowMachine.Utils.map(Math.abs(ampX), 0, Math.abs(this.amplitude.x), .1, .3);
